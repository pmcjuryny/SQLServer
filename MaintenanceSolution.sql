...
DECLARE @BackupDirectory nvarchar(max)     = \\usadanfsdbbak1\dbadaily1\MSSQL        -- Specify the backup root directory. If no directory is specified, the default backup directory is used.
...
BEGIN
  ...
  SELECT 'DBA_TEAM.DatabaseBackup - SYSTEM_DATABASES - FULL',
         'EXECUTE [dbo].[DatabaseBackup]' + CHAR(13) + CHAR(10) + '@Databases = ''SYSTEM_DATABASES'',' + CHAR(13) + CHAR(10) + '@Directory = ' + ISNULL('N''' + REPLACE(@BackupDirectory,'''','''''') + '''','NULL') + ',' + CHAR(13) + CHAR(10) + '@BackupType = ''FULL'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupMode = ''AFTER_BACKUP'',' + CHAR(13) + CHAR(10) + '@COMPRESS = ''Y'',' + CHAR(13) + CHAR(10) + '@ChangeBackupType = ''Y'',' + CHAR(13) + CHAR(10) + '@BufferCount = ''50'',' + CHAR(13) + CHAR(10) + '@MaxTransferSize = ''4194304'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupTime = ' + ISNULL(CAST(@CleanupTime AS nvarchar),'NULL') + ',' + CHAR(13) + CHAR(10) + '@CheckSum = ''Y'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'DatabaseBackup',
         'FULL'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA_TEAM.DatabaseBackup - USER_DATABASES - DIFF',
         'EXECUTE [dbo].[DatabaseBackup]' + CHAR(13) + CHAR(10) + '@Databases = ''USER_DATABASES'',' + CHAR(13) + CHAR(10) + '@Directory = ' + ISNULL('N''' + REPLACE(@BackupDirectory,'''','''''') + '''','NULL') + ',' + CHAR(13) + CHAR(10) + '@BackupType = ''DIFF'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupMode = ''AFTER_BACKUP'',' + CHAR(13) + CHAR(10) + '@COMPRESS = ''Y'',' + CHAR(13) + CHAR(10) + '@ChangeBackupType = ''Y'',' + CHAR(13) + CHAR(10) + '@BufferCount = ''50'',' + CHAR(13) + CHAR(10) + '@MaxTransferSize = ''4194304'',' + CHAR(13) + CHAR(10) + '@CleanupTime = ' + ISNULL(CAST(@CleanupTime AS nvarchar),'NULL') + ',' + CHAR(13) + CHAR(10) + '@CheckSum = ''Y'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
          @DatabaseName,
         'DatabaseBackup',
         'DIFF'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA_TEAM.DatabaseBackup - USER_DATABASES - FULL',
         'EXECUTE [dbo].[DatabaseBackup]' + CHAR(13) + CHAR(10) + '@Databases = ''USER_DATABASES'',' + CHAR(13) + CHAR(10) + '@Directory = ' + ISNULL('N''' + REPLACE(@BackupDirectory,'''','''''') + '''','NULL') + ',' + CHAR(13) + CHAR(10) + '@BackupType = ''FULL'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupMode = ''AFTER_BACKUP'',' + CHAR(13) + CHAR(10) + '@COMPRESS = ''Y'',' + CHAR(13) + CHAR(10) + '@ChangeBackupType = ''Y'',' + CHAR(13) + CHAR(10) + '@BufferCount = ''50'',' + CHAR(13) + CHAR(10) + '@MaxTransferSize = ''4194304'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupTime = ' + ISNULL(CAST(@CleanupTime AS nvarchar),'NULL') + ',' + CHAR(13) + CHAR(10) + '@CheckSum = ''Y'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'DatabaseBackup',
         'FULL'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01, OutputFileNamePart02)
  SELECT 'DBA_TEAM.DatabaseBackup - USER_DATABASES - LOG',
         'EXECUTE [dbo].[DatabaseBackup]' + CHAR(13) + CHAR(10) + '@Databases = ''USER_DATABASES'',' + CHAR(13) + CHAR(10) + '@Directory = ' + ISNULL('N''' + REPLACE(@BackupDirectory,'''','''''') + '''','NULL') + ',' + CHAR(13) + CHAR(10) + '@BackupType = ''LOG'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupMode = ''AFTER_BACKUP'',' + CHAR(13) + CHAR(10) + '@COMPRESS = ''Y'',' + CHAR(13) + CHAR(10) + '@ChangeBackupType = ''Y'',' + CHAR(13) + CHAR(10) + '@BufferCount = ''50'',' + CHAR(13) + CHAR(10) + '@MaxTransferSize = ''4194304'',' + CHAR(13) + CHAR(10) + '@Verify = ''N'',' + CHAR(13) + CHAR(10) + '@CleanupTime = ' + ISNULL(CAST(@CleanupTime AS nvarchar),'NULL') + ',' + CHAR(13) + CHAR(10) + '@CheckSum = ''Y'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'DatabaseBackup',
         'LOG'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.DatabaseIntegrityCheck - SYSTEM_DATABASES',
         'EXECUTE [dbo].[DatabaseIntegrityCheck]' + CHAR(13) + CHAR(10) + '@Databases = ''SYSTEM_DATABASES'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'DatabaseIntegrityCheck'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.DatabaseIntegrityCheck - USER_DATABASES',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.IndexOptimize - USER_DATABASES',
         'EXECUTE [dbo].[IndexOptimize]' + CHAR(13) + CHAR(10) + '@Databases = ''USER_DATABASES'',+ CHAR(13) + CHAR(10) + '@FragmentationMedium = ''INDEX_REORGANIZE,INDEX_REBUILD_ONLINE,INDEX_REBUILD_OFFLINE'','+ CHAR(13) + CHAR(10) + '@FragmentationHigh = ''INDEX_REBUILD_ONLINE,INDEX_REBUILD_OFFLINE'','+ CHAR(13) + CHAR(10) + '@FragmentationLevel1 = 5,' + CHAR(13) + CHAR(10) + '@FragmentationLevel2 = 30,' + CHAR(13) + CHAR(10) + '@UpdateStatistics = ''ALL'',' + CHAR(13) + CHAR(10) + '@OnlyModifiedStatistics = ''Y'',' + CHAR(13) + CHAR(10) + '@LogToTable = ''' + @LogToTable + '''',
         @DatabaseName,
         'IndexOptimize'

  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.sp_delete_backuphistory',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.sp_purge_jobhistory',
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'DBA_TEAM.CommandLog Cleanup',
  ...
  SELECT 'DBA_TEAM.Output File Cleanup',
